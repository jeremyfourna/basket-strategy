...
function playersPositionsConfigZoomedF(zoomSize, playersPosConfig) {
...
function generatePlayersPositionsF(wishedZoom, playersPositionsSelected, context) {
...
const playersPositionsConfigZoomed = R.curry(playersPositionsConfigZoomedF);
const generatePlayersPositions = R.curry(generatePlayersPositionsF);
